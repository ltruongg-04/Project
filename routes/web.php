...
Route::delete('/wishlist/item/reomve/{rowId}',[WishlistController::class,'remove_item'])->name('wishlist.item.remove');
Route::delete('/wishlist/clear',[WishlistController::class,'empty_wishlist'])->name('wishlist.item.clear');
Route::post('wishlist/move-to-cart/{rowId}',[WishlistController::class,'move-to-cart'])->name('wishlist.move.to.cart');
