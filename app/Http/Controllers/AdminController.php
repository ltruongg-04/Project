...
class AdminController extends Controller
{
    ...
    public function brand_store(Request $request) {
        ...
        $brand->save();
        return redirect()->route('admin.brands')->with('status','Brand has been add succesfully!');
    }
    ...
    public function category_store(Request $request) 
    {
        ...
        $category->save();
        return redirect()->route('admin.categories')->with('status','Category has been add succesfully!');
    }
    ...
    {
        $category = Category::find($id);
        if(File::exists(public_path('uploads/categories').'/'.$category->imange))
        {
            File::delete(public_path('uploads/categories').'/'.$category->image);
        }
        $category->delete();
