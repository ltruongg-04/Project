              ...
              <tr>
                ...
                <td>
                  <div class="qty-control position-relative">
                    ...
                    <form method="POST" action="{{ route('cart.qty.decrease',['rowId'=>$item->qty]) }}">
                      @csrf
                      @method('PUT')
                      <div class="qty-control__reduce">-</div>
                    </form>

                    <form method="POST" action="{{ route('cart.qty.increase',['rowId'=>$item->qty]) }}">
                      @csrf
                      @method('PUT')
              ...
              <table class="cart-totals">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>${{Session::get('discouts')['discount']}}</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <th>VAT</th>
                    <td>${{Session::ger('discounts')['tax']}}</td>
                  </tr>
                  <tr>
                    <th>Total</th>
